...
static BOOL ZWallowWriteAudio = NO;
...
- (void)startRecording;
{
    ...
    isRecording = YES;
    ZWallowWriteAudio = NO;
   // NSLog(@"startRecording===allowWriteAudio = NO");
    allowWriteAudio = NO;
    ...
    runSynchronouslyOnContextQueue(_movieWriterContext, ^{
       //isRecording = NO;
        ...
        if (assetWriter.status == AVAssetWriterStatusCompleted || assetWriter.status == AVAssetWriterStatusCancelled || assetWriter.status == AVAssetWriterStatusUnknown)
        {
         ...
         allowWriteAudio = NO;
      //  NSLog(@"finishRecordingWithCompletionHandler==allowWriteAudio");
...
- (void)processAudioBuffer:(CMSampleBufferRef)audioBuffer;
{
    ...
    {
       // NSLog(@"processAudioBuffer====allowWriteAudio");
        return;
    }
